...
public class BArticleDetailFragment extends BaseFragment {
    /**
     ...
     */
    private BoardContent.BoardItem dummyItem;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            dummyItem = BoardContent.ITEM_MAP.get(getArguments().getString(ARG_ITEM_ID));
        }
    ...
    public static BArticleDetailFragment newInstance(String itemID) {
        BArticleDetailFragment fragment = new BArticleDetailFragment();
        Bundle args = new Bundle();
        args.putString(BArticleDetailFragment.ARG_ITEM_ID, itemID);
        fragment.setArguments(args);
        return fragment;
    }

    public BArticleDetailFragment() {}
}
